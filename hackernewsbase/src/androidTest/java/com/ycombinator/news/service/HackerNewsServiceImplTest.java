...
public class HackerNewsServiceImplTest extends AndroidTestCase
{
    ...
    {
        Iterator<UserDTO> userDTOIterator = hackerNewsService.getUser(new UserId("jl")).take(1).toBlocking().getIterator();
    ...
    {
        Iterator<ItemDTO> iterator = hackerNewsService.getContent(new ItemId(8863)).take(1).toBlocking().getIterator();
    ...
    {
        Iterator<ItemDTO> itemDTOIterator = hackerNewsService.getContent(new ItemId(2921983)).take(1).toBlocking().getIterator();
    ...
    {
        Iterator<ItemDTO> itemDTOIterator = hackerNewsService.getContent(new ItemId(126809)).take(1).toBlocking().getIterator();
    ...
    {
        Iterator<ItemDTO> itemDTOIterator = hackerNewsService.getContent(new ItemId(160705)).take(1).toBlocking().getIterator();
    ...
    {
        Iterator<ItemDTO> itemDTOIterator = hackerNewsService.getContent(new ItemId(9052645)).take(1).toBlocking().getIterator();
    ...
    {
        Iterator<List<ItemId>> itemDTOListIterator = hackerNewsService.getTopStories().take(1).toBlocking().getIterator();
    ...
    {
        Iterator<ItemId> itemIdIterator = hackerNewsService.getMaxItem().take(1).toBlocking().getIterator();
    ...
    {
        Iterator<UpdateDTO> updateDTOIterator = hackerNewsService.getUpdates().take(1).toBlocking().getIterator();
